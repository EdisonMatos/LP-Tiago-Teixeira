export default function IconFeatureCard(props) {
  ...
  return (
    <div
      className={`w-full p-0 tablet1:w-[290px] mb-[40px] desktop1:w-[260px] desktop1:h-[300px] flex flex-col items-center desktop1:hover:scale-110 transition desktop1:p-0 ${className}`}
    >
